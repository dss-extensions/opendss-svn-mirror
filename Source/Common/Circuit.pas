    ...
    begin
        ...
        begin
            ...
            for i := 1 to High(Link_Branches) do
                with solution do
                    Locations[i] := get_PDE_Bus1_Location(Link_Branches[i]);
        end
        else
        begin
