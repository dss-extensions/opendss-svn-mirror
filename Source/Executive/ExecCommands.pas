...
//       88:;
      ...
      113: Begin DSSInfoMessageDlg('Winsock TCP/IP disconnection is not supported in FPC version, it will be migrated to Indy (soon...)'); CmdResult := 0; end;
            ...
            135:
                GlobalResult := GISDrawCircuit;           // Draws the circuit on top of the map in DSS-GIS
            136:
            begin
                Parser[ActiveActor].NextParam;
            ...
            137:
                GlobalResult := export_mapGIS();           // exports the current map view into the model's folder
            138:
            begin
                Parser[ActiveActor].NextParam;
            ...
            156:
                GlobalResult := GISClose();
            157:
                GlobalResult := Get_distance();
            158:
                GlobalResult := GISStartSelect();
            159:
