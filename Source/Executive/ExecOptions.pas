...
6
 ...
 // deprecated         130: ActiveCircuit[ActiveActor].MarkPVSystems2   := InterpretYesNo(Param);
  // deprecated           132: ActiveCircuit[ActiveActor].MarkStorage2     := InterpretYesNo(Param);
            ...
            140:
                ActiveCircuit[ActiveActor].Solution.GenGainNCIM := Parser[ActiveActor].DblValue;
            141:
            begin
                with ActiveCircuit[ActiveActor] do
                begin
            ...
            case ParamPointer of
                ...
                138:
                    if AutoDisplayShowReport then
                        ...
                        AppendGlobalResult('No');
                139:
                    if ActiveCircuit[ActiveActor].Solution.IgnoreQLimit then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                140:
                    ...
                    begin
                        ...
                        begin
                            ...
                            begin
                                ...
                                inc(i);
                                if i <= ActiveCktElement.NPhases then
                                    TmpStr := TmpStr + '|'
                            end;
                            TmpStr := TmpStr + ']'
                        end
                ...
                150:
                begin
                    if not NoProgressBarFormAllowed then
                        AppendGlobalResult('Yes')
                    else
                        AppendGlobalResult('No');
                end
