...
Begin
    ...
    If InverterON Then  Begin
       If Panelkw < CutOutkW  Then  Begin
         InverterON := FALSE;
       End;
    End
    ELSE Begin
       If Panelkw >= CutInkW  Then  Begin
         InverterON := TRUE;
       End;
    End;
    ...
    // Limit kvar so that kVA of inverter is not exceeded
     ...
     If kVA_Gen > kVArating Then Begin
         If kW_out > kVArating Then Begin
              kW_out   := kVARating;
              kvar_out := 0.0;
         End
