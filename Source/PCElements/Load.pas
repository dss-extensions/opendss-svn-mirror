        ...
        begin
            ...
            begin
              ...
              {Compute Q component of current}
                ...
                Caccum(Curr, Cvar_);  // add in Q component of current
            end;
