    ...
    begin
        ...
        begin
            ...
            case ParamPointer of
                ...
                34:
                    CtrlModel := Parser[ActorID].IntValue;
    ...
    begin
        ...
        begin
          ...
          // DER may have been disabled later; treat that the same way here.
            if (ControlledElement = nil) or (not ControlledElement.Enabled) then
                Continue;
    ...
    begin
        ...
        begin
            ...
            for j := 1 to numNodes do
                case connection of
                    1:
                        cBuffer[j] := Csub(ControlledElement.Vterminal^[j], ControlledElement.Vterminal^[NextDeltaPhase(j)]);   // Delta
                else
  ...
  // if list is not defined, go make one from all PVSystem/Storage in circuit
    ...
    // separately based on the PVSystem/Storage's terminal voltages, etc.
      ...
      // This keeps the InvControl in the model but idle for its disabled DERs.
            if (CtrlVars[i].ControlledElement = nil) or (not CtrlVars[i].ControlledElement.Enabled) then
                Continue;
            ...
            begin
                ...
                if PVSys <> nil then
                    GetmonVoltage(ActorID, Vpresent, i, BasekV, PVSys.Connection)
                else
  ...
  //Initialize arrays
    ...
    begin
      ...
      // Sets the constants for the PI controller
            ...
            if Storage <> nil then
                QOldAVR := -Storage.kvarLimitNeg / 2.0
            else
                QOldAVR := 0.0;
            QOldDRC := -1.0;
            QOldVVDRC := -1.0;
