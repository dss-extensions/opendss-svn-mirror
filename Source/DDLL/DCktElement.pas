...
begin
    case mode of
        ...
        19:
        begin               // CktElement.VoltagesMagAng - Return voltages for all terminals
            myType := 3;        // Complex
            setlength(myPolarArray, 1);
            myPolarArray[0] := ctopolar(CZero);
            if ActiveCircuit[ActiveActor] <> nil then
        ...
        20:
        begin             // CktElement.TotalPowers - Return total powers for the active element at all terminals
            myType := 3;      // Complex
            setlength(myCmplxArray, 1);
            myCmplxArray[0] := CZero;
            if ActiveCircuit[ActiveActor] <> nil then
        ...
        begin            // CktElement.AllLosses
            ...
            begin
                ...
                with ActiveCircuit[ActiveActor] do
                    ActiveCktElement.GetLosses(S_TotalLosses, S_LoadLosses, S_NoLoadLosses, ActiveActor);
